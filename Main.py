...
tiles_img_obj = []
for i in range(11):
    nombre_archivo_imagen = "Images/{0}.png".format(i)
...
def genera_coords_tiles(tiles):
    ...
    for i in range(NUMBER_OF_TILES):
        ...
        tile_img = 10 # inicia con tarjeta " ? "
...
def revisa_picked(tomada):
    ...
    if len(picked_tiles) >= 2:
        ...
        # si no son iguales se voltean y genera nueva lista para tomar
            ...
            # detener el juego antes de cambiarlas
            pygame.time.wait(1000)
            # cambiar las imagenes
            coords_tiles[picked_index_1][2] = 10 # numero de la tarjeta " ? "
